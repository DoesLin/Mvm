...
if [[ "$?" != "0" ]]; then
    curl "https://secure.bocqfamily.fr/enseignement/c/requestid.php?mail=$mail"
...
curl -F"operation=upload" -F"file=@$archive" "https://secure.bocqfamily.fr/enseignement/c/upload.php?mail=$mail&id=$id" -o downloaded.tar.gz
