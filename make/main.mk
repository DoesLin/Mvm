WARNINGS=-Wall -Wimplicit -Wunused -Wunused-result -Wshadow -Wconversion -Wfloat-equal -Wparentheses -Wundef -Wextra --std=c99 -Wstrict-prototypes -Wwrite-strings -Wconversion -fdiagnostics-show-option -Werror ${EXTRA_WARNINGS}
